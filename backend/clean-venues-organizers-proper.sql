...
-- Set venue_id to NULL in events to avoid foreign key constraint

-- First, remove organizer and venue references from events
...
UNION ALL
SELECT 'Events without venue/organizer: ' || COUNT(*) FROM events WHERE organizer_id IS NULL AND venue_id IS NULL;