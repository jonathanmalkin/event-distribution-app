-- Test script to properly clean database respecting all constraints
-- Step 1: Clean all data in proper order (respecting foreign keys)

-- Delete import conflicts first
...
-- Verify cleanup
SELECT 'Events count: ' || COUNT(*) AS cleanup_results FROM events
UNION ALL
